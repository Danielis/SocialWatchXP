angular.module('youtube-player', ['ng'])
...
.service('youtubeEmbedUtils', function($window, $rootScope) {
    ...
    Service.getIdFromURL = function getIdFromURL(url) {
        ...
        return id;
    }; // end function getIdFromURL

    Service.getTimeFromURL = function getTimeFromURL(url) {
        url = url || '';

        // t=4m20s returns ['t=4m20s', '4', '20']
        // t=46s returns ['t=46s', '46']
        // t=46 returns ['t=46', '46']
    ...
    }; // end function $window.onYouTubeIframeAPIReady

    return Service;
}) // end service youtubeEmbedUtils

.directive('youtubePlayer', function(youtubeEmbedUtils) {
	var uniqId = 1;
    ...
    return {
    	...
    	link: function(scope, element, attrs) {
    		...
    		} //e dn function onPlayerStateChange
